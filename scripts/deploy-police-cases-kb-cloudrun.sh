...
WORKER_INDIAN_KANOON_TOKEN_SECRET="${WORKER_INDIAN_KANOON_TOKEN_SECRET:-indian-kanoon-api-token:latest}"
...
WORKER_TRANSLATION_PROVIDER="${WORKER_TRANSLATION_PROVIDER:-openai}"
WORKER_TRANSLATION_OPENAI_MODEL="${WORKER_TRANSLATION_OPENAI_MODEL:-gpt-4o}"
WORKER_TRANSLATION_PROJECT_ID="${WORKER_TRANSLATION_PROJECT_ID:-$PROJECT}"
WORKER_TRANSLATION_LOCATION="${WORKER_TRANSLATION_LOCATION:-global}"
WORKER_TRANSLATION_TARGET_LANGUAGE="${WORKER_TRANSLATION_TARGET_LANGUAGE:-en}"
WORKER_TRANSLATION_REQUIRED_FOR_NON_ENGLISH="${WORKER_TRANSLATION_REQUIRED_FOR_NON_ENGLISH:-true}"
WORKER_TRANSLATION_AUTO_APPROVE="${WORKER_TRANSLATION_AUTO_APPROVE:-false}"
# District-court acquisition (Mode 4 captcha solving via Document AI — owner-authorized 2026-06-23)
WORKER_DISTRICT_ACQUISITION_ENABLED="${WORKER_DISTRICT_ACQUISITION_ENABLED:-true}"
WORKER_ECOURTS_FETCH_ENABLED="${WORKER_ECOURTS_FETCH_ENABLED:-true}"
WORKER_ECOURTS_CAPTCHA_SOLVER_ENABLED="${WORKER_ECOURTS_CAPTCHA_SOLVER_ENABLED:-true}"
WORKER_CAPTCHA_SOLVER_PROVIDER="${WORKER_CAPTCHA_SOLVER_PROVIDER:-documentai}"
...
require_secret "${WORKER_INDIAN_KANOON_TOKEN_SECRET%%:*}"
ensure_secret_accessor "${WORKER_INDIAN_KANOON_TOKEN_SECRET%%:*}"
...
worker_env_vars=(
  ...
  "TRANSLATION_PROVIDER=${WORKER_TRANSLATION_PROVIDER}"
  "TRANSLATION_OPENAI_MODEL=${WORKER_TRANSLATION_OPENAI_MODEL}"
  "TRANSLATION_PROJECT_ID=${WORKER_TRANSLATION_PROJECT_ID}"
  "TRANSLATION_LOCATION=${WORKER_TRANSLATION_LOCATION}"
  "TRANSLATION_TARGET_LANGUAGE=${WORKER_TRANSLATION_TARGET_LANGUAGE}"
  "TRANSLATION_GLOSSARY_PATH=/app/config/legal_translation_glossary.yaml"
  "TRANSLATION_REQUIRED_FOR_NON_ENGLISH=${WORKER_TRANSLATION_REQUIRED_FOR_NON_ENGLISH}"
  "TRANSLATION_AUTO_APPROVE=${WORKER_TRANSLATION_AUTO_APPROVE}"
  "DISTRICT_ACQUISITION_ENABLED=${WORKER_DISTRICT_ACQUISITION_ENABLED}"
  "ECOURTS_FETCH_ENABLED=${WORKER_ECOURTS_FETCH_ENABLED}"
  "ECOURTS_COMMERCIAL_CAPTCHA_SOLVER_ENABLED=${WORKER_ECOURTS_CAPTCHA_SOLVER_ENABLED}"
  "CAPTCHA_SOLVER_PROVIDER=${WORKER_CAPTCHA_SOLVER_PROVIDER}"
)
...
worker_secret_vars=(
  ...
  "INDIAN_KANOON_API_TOKEN=${WORKER_INDIAN_KANOON_TOKEN_SECRET}"
)
if [ -n "$WORKER_GEMINI_API_KEY_SECRET" ]; then
